...
namespace Northwind.Entites
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Kategory> Kategories { get; set; } = null!;
        ...
        public virtual DbSet<SemtMah> SemtMahs { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kategory>(entity =>
            {
                ...
                entity.Property(e => e.KategoryAdi)
                    .HasMaxLength(50)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<Ulkeler>(entity =>
            {
                ...
                entity.Property(e => e.IkiliKod).HasMaxLength(2);

                entity.Property(e => e.TelKodu).HasMaxLength(6);

                entity.Property(e => e.UcluKod).HasMaxLength(3);

                entity.Property(e => e.UlkeAdi).HasMaxLength(100);
            });
            ...
            modelBuilder.Entity<Urunler>(entity =>
            {
                ...
                entity.HasOne(d => d.Birim)
                    ...
                    .HasConstraintName("FK_Urunler_ToBirim");

                entity.HasOne(d => d.Kategory)
                    .WithMany(p => p.Urunlers)
                    .HasForeignKey(d => d.KategoryId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_Urunler_ToKategory");
            });
